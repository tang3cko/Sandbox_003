# 04_shaders_in_godot — Swarm Survivor

Phase 5: GDShader, MultiMesh, CompositorEffect
...
Phases 1-4: **1 entity = 1 Node3D**
Phase 5: **All entities = data arrays + MultiMesh rendering**
...
None. Enemies are data arrays, not nodes. This is an intentional architectural shift from Phase 4.
